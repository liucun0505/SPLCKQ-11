// TESTRemoteUpgrade.cpp : implementation file
//

#include "stdafx.h"
#include "ImitateMeter.h"
#include "TESTRemoteUpgrade.h"
...
IMPLEMENT_DYNAMIC(CTESTRemoteUpgrade, CWnd)

CTESTRemoteUpgrade::CTESTRemoteUpgrade()
{
...
BEGIN_MESSAGE_MAP(CTESTRemoteUpgrade, CWnd)
END_MESSAGE_MAP()
void CTESTRemoteUpgrade::C3762_TEST(HTREEITEM hTree)
{
...
// CTESTRemoteUpgrade message handlers
