// TESTParameter.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CTESTParameter, CWnd)

CTESTParameter::CTESTParameter()
{
...
BEGIN_MESSAGE_MAP(CTESTParameter, CWnd)
END_MESSAGE_MAP()
void CTESTParameter::C3762_TEST(HTREEITEM hTree)
{
...
// CTESTParameter message handlers
