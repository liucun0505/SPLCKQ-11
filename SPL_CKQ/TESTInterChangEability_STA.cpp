// TESTInterChangEability_STA.cpp : implementation file
//

#include "stdafx.h"
#include "ImitateMeter.h"
#include "TESTInterChangEability_STA.h"
...
IMPLEMENT_DYNAMIC(CTESTInterChangEability_STA, CWnd)

CTESTInterChangEability_STA::CTESTInterChangEability_STA()
{
...
BEGIN_MESSAGE_MAP(CTESTInterChangEability_STA, CWnd)
END_MESSAGE_MAP()

void CTESTInterChangEability_STA::C3762_TEST(HTREEITEM hTree)
{
...
// CTESTInterChangEability_STA message handlers
